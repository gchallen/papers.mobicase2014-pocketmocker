...
Before developing a prototype on just a belief, we distributed an IRB-approved
survey to students, faculty and staff of the University at Buffalo\footnote{We
discuss this survey in more detail in our concurrent publication submitted to
HotPlanet 2014}. No incentives were provided for completing  the  survey,  and
all  respondents were  required to indicate consent before proceeding to the
questions.  Over four days, we recorded 91 responses. First,  we  found  that
respondents  to be  reasonably suspicious of what apps might know about them,
with 52\% indicating  that  an  app  might  know  at  least  one personal
attribute  to a  level  that  we  marked  as  unreasonable  today  but  only
18\% indicating that  apps might know two attributes of unreasonable levels.
And  when asked about mocking,  of the 91 users that  completed  the  survey,
