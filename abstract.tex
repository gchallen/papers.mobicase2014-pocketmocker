...
discuss the design of DataDecoy, which uses user-initiated context trace
recording and replay to enable objective-driven context mocking. Our evaluation
shows that users want to use DataDecoy, that DataDecoy can mock popular
smartphone apps, and that DataDecoy is usable.  \end{abstract}
